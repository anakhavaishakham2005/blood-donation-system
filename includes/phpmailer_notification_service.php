<?php
// includes/phpmailer_notification_service.php
// Enhanced notification service using PHPMailer

require_once __DIR__ . '/config.php';
require_once __DIR__ . '/functions.php';

// Check if PHPMailer is available
if (file_exists(__DIR__ . '/../phpmailer/autoload.php')) {
    require_once __DIR__ . '/../phpmailer/autoload.php';
    require_once __DIR__ . '/phpmailer_service.php';
    
    class PHPMailerNotificationService {
        private $conn;
        private $phpmailerService;
        
        public function __construct($connection) {
            $this->conn = $connection;
            $this->phpmailerService = new PHPMailerService($connection);
        }
        ...
        private function createDonorNotificationHTML($donor, $request) {
            ...
            $html .= ".btn { background: #28a745; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; display: inline-block; margin: 10px 0; }";
        ...
        private function createAdminNotificationHTML($request) {
            ...
            $html .= ".footer { background: #f8f9fa; padding: 15px; text-align: center; font-size: 12px; }";
            $html .= ".btn { background: #007bff; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; display: inline-block; margin: 10px 0; }";
            $html .= "</style></head><body>";
    ...
    // Fallback to basic notification service if PHPMailer is not available
    class PHPMailerNotificationService {
        private $conn;
        ...
        public function notifyDonorMatch($donor_id, $request_id) {
            ...
            return send_notification_email("test@example.com", "Test", "PHPMailer not available");
        }
